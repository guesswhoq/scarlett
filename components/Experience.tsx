...
const experienceData = [
  ...
  {
    role: '패션 & 뷰티 라이브커머스 쇼호스트(Freelancer)',
    company: '프리랜서 (나인틴나인 외 다수 브랜드)',
  ...
  {
    role: '패션 브랜드 모델(Freelancer)',
    company: '프리랜서 (Guess 외 다수 브랜드)',
  ...
  {
    role: '비즈니스 영어 강사(Freelancer)',
    company: '프리랜서 (글로벌어학원 등)',
    period: '2020.10 - 2025.05',
  ...
  {
    role: '뷰티 & 라이프스타일 브랜드 모델(Freelancer)',
